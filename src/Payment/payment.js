...
const Payment = () => {
    ...
    if (sessionStorage.length > 0) {
        ...
        totalPrice = parseInt(userData.price) + parseInt(userData.bikeDetails.additionalCost)
    }
            ...
            <div className={styles.paymentFormIntro}>
                ...
                <div className={styles.paymentFormMain}>
                    <div className={styles.userInformationMain}>
                        ...
                        <div className={styles.userInformationContainer}>
                            <p className={styles.userInformationP}>Date: {Object.keys(userData).length > 0 ? `${userData.date} at ${userData.time}.00` : 'No information'}</p>
                        </div>
                        <div className={styles.userInformationContainer}>
                            ...
                            <div className={styles.innerDetails}>
                                ...
                                <p className={styles.userInformationP}>{Object.keys(userData).length > 0 ? `£${userData.price}` : 'No information'}</p>
                            </div>
                            <div className={styles.innerDetails}>
