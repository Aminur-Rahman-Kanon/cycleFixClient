            ...
            <div className={styles.headerContainer3Cards}>
                ...
                <div className={styles.headerContainer3Services}>
                    <div data-aos="fade-right" data-aos-delay="100" className={styles.headerContainer3Service}>
                        <FontAwesomeIcon icon={ faClock } className={styles.headerContainer3ServiceIcon} data-testid="clock"/>
                    ...
                    <div data-aos="fade-right" data-aos-delay="300" className={styles.headerContainer3Service}>
                        <FontAwesomeIcon icon={ faScrewdriverWrench } className={styles.headerContainer3ServiceIcon} data-testid="wrench"/>
                    ...
                    <div data-aos="fade-right" data-aos-delay="500" className={styles.headerContainer3Service}>
                        <FontAwesomeIcon icon={ faUserTie } className={styles.headerContainer3ServiceIcon} data-testid="tie"/>
                    ...
                    <div data-aos="fade-right" data-aos-delay="700" className={styles.headerContainer3Service}>
                        <FontAwesomeIcon icon={ faChargingStation } className={styles.headerContainer3ServiceIcon} data-testid="charging-station"/>
                    ...
                    <div data-aos="fade-right" data-aos-delay="900" className={styles.headerContainer3Service}>
                        <FontAwesomeIcon icon={ faPersonBiking} className={styles.headerContainer3ServiceIcon} data-testid="biking"/>
                    ...
                    <div data-aos="fade-right" data-aos-delay="1000" className={styles.headerContainer3Service}>
                        <FontAwesomeIcon icon={ faMotorcycle } className={styles.headerContainer3ServiceIcon} data-testid="motorcycle"/>
